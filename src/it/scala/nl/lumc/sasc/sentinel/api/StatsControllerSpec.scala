...
import nl.lumc.sasc.sentinel.biopet.gentrap.GentrapAlignmentStats
...
class StatsControllerSpec extends SentinelServletSpec {
  ...
  implicit val runsProcessorMakers = Set(
    makeDelayedProcessor[nl.lumc.sasc.sentinel.biopet.gentrap.GentrapRunsProcessor],
  ...
  s"GET '$baseEndpoint/gentrap/alignments'" >> {
    ...
    "when an invalid library type is specified should" >> inline {
      ...
      new Context.PriorRequests {
        ...
        "return a JSON object containing the expected message" in {
          ...
          priorResponse.body must /("hint" -> "Valid values are 'paired', 'single'.")
        }
      }
    }
    ...
    "when a user tries to authenticate by only providing his/her user ID should" >> inline {
      ...
      new Context.PriorRequests {
        def request = () => get(endpoint, Seq(("userId", UserExamples.avg.id))) { response }
        def priorRequests = Seq(request)
    ...
    "when a user tries to authenticate by only providing his/her API key should" >> inline {
      ...
      new Context.PriorRequests {
        def request = () => get(endpoint, headers = Map(HeaderApiKey -> UserExamples.avg.activeKey)) { response }
        def priorRequests = Seq(request)
    ...
    "using the gentrap v0.4 summary (2 samples, 1 read group)" >> inline {
      ...
      new Context.PriorRunUploadClean {
        ...
        def uploadSet = UploadSet(UserExamples.avg, BiopetSummaryExamples.Gentrap.V04.MSampleSRG, "gentrap")
    ...
    "using the gentrap v0.4 summary (3 samples, 6 read groups, mixed library types)" >> inline {
      ...
      new Context.PriorRunUploadClean {
        ...
        def uploadSet = UploadSet(UserExamples.avg, BiopetSummaryExamples.Gentrap.V04.MSampleMRGMixedLib, "gentrap")
        def priorRequests = Seq(uploadSet.request)
        ...
        "when a non-uploader authenticates correctly should" >> inline {
          ...
          def params = Seq(("userId", UserExamples.avg2.id))
          def headers = Map(HeaderApiKey -> UserExamples.avg2.activeKey)
        ...
        "when queried with accLevel set to 'sample'" >> {
          ...
          "when a non-uploader authenticates correctly should" >> inline {
            ...
            def params = Seq(("userId", UserExamples.avg2.id), ("accLevel", "sample"))
            def headers = Map(HeaderApiKey -> UserExamples.avg2.activeKey)
        ...
        "when queried with accLevel set to 'readGroup'" >> {
          ...
          "when a non-uploader authenticates correctly should" >> inline {
            ...
            def params = Seq(("userId", UserExamples.avg2.id), ("accLevel", accLevel))
            def headers = Map(HeaderApiKey -> UserExamples.avg2.activeKey)
    ...
    "using multiple gentrap files uploaded by different users" >> inline {
      ...
      new Context.PriorRunUploadClean {
        ...
        def upload1 = UploadSet(UserExamples.admin, BiopetSummaryExamples.Gentrap.V04.SSampleMRG, "gentrap")
        def upload2 = UploadSet(UserExamples.avg, BiopetSummaryExamples.Gentrap.V04.MSampleMRGMixedLib, "gentrap")
        def upload3 = UploadSet(UserExamples.avg, BiopetSummaryExamples.Gentrap.V04.MSampleSRG, "gentrap")
        ...
        "when one of the uploaders authenticates correctly should" >> inline {
          ...
          new Context.PriorRequests {
            ...
            "return some items with their labels" in {
              priorResponse.jsonBody must beSome.like { case json =>
                val res = json.extract[Seq[GentrapAlignmentStats]]
        ...
        "when using the default parameter should" >> inline {
          ...
          new Context.PriorRequests {
            ...
            "return a JSON object containing the expected attributes" in {
              ...
              priorResponse.body must /("nBasesMrna") /("nDataPoints" -> (nSingleSample + nPairedSample))
              ...
              priorResponse.body must /("nReadsProperPair") /("nDataPoints" -> nPairedSample)
              priorResponse.body must /("nReadsSingleton") /("nDataPoints" -> nPairedSample)
              priorResponse.body must /("nReadsTotal") /("nDataPoints" -> (nSingleSample + nPairedSample))
              priorResponse.body must /("pctBasesCoding") /("nDataPoints" -> (nSingleSample + nPairedSample))
              priorResponse.body must /("pctBasesIntergenic") /("nDataPoints" -> (nSingleSample + nPairedSample))
              priorResponse.body must /("pctBasesIntron") /("nDataPoints" -> (nSingleSample + nPairedSample))
              priorResponse.body must /("pctBasesMrna") /("nDataPoints" -> (nSingleSample + nPairedSample))
              priorResponse.body must /("pctBasesUtr") /("nDataPoints" -> (nSingleSample + nPairedSample))
              priorResponse.body must /("pctChimeras") /("nDataPoints" -> nPairedSample)
              priorResponse.body must /("pctReadsAlignedTotal") /("nDataPoints" -> (nSingleSample + nPairedSample))
              priorResponse.body must /("pctReadsProperPair") /("nDataPoints" -> nPairedSample)
              priorResponse.body must /("pctReadsSingleton") /("nDataPoints" -> nPairedSample)
        ...
        "when accLevel is set to 'readGroup' should" >> inline {
          ...
          new Context.PriorRequests {
            ...
            "return a JSON object containing the expected attributes" in {
              ...
              priorResponse.body must /("nBasesMrna") /("nDataPoints" -> (nSingleLib + nPairedLib))
              ...
              priorResponse.body must /("nReadsProperPair") /("nDataPoints" -> nPairedLib)
              priorResponse.body must /("nReadsSingleton") /("nDataPoints" -> nPairedLib)
              priorResponse.body must /("nReadsTotal") /("nDataPoints" -> (nSingleLib + nPairedLib))
              priorResponse.body must /("pctBasesCoding") /("nDataPoints" -> (nSingleLib + nPairedLib))
              priorResponse.body must /("pctBasesIntergenic") /("nDataPoints" -> (nSingleLib + nPairedLib))
              priorResponse.body must /("pctBasesIntron") /("nDataPoints" -> (nSingleLib + nPairedLib))
              priorResponse.body must /("pctBasesMrna") /("nDataPoints" -> (nSingleLib + nPairedLib))
              priorResponse.body must /("pctBasesUtr") /("nDataPoints" -> (nSingleLib + nPairedLib))
              priorResponse.body must /("pctChimeras") /("nDataPoints" -> nPairedLib)
              priorResponse.body must /("pctReadsAlignedTotal") /("nDataPoints" -> (nSingleLib + nPairedLib))
              priorResponse.body must /("pctReadsProperPair") /("nDataPoints" -> nPairedLib)
              priorResponse.body must /("pctReadsSingleton") /("nDataPoints" -> nPairedLib)
  ...
  s"GET '$baseEndpoint/gentrap/sequences'" >> {
    ...
    "when an invalid sequencing QC phase is specified should" >> inline {
      ...
      new Context.PriorRequests {
        ...
        "return a JSON object containing the expected message" in {
          ...
          priorResponse.body must /("hint" -> "Valid values are 'processed', 'raw'.")
        }
      }
    }
    ...
    "using multiple gentrap files uploaded by different users" >> inline {
      ...
      new Context.PriorRunUploadClean {
        ...
        def upload1 = UploadSet(UserExamples.admin, BiopetSummaryExamples.Gentrap.V04.SSampleMRG, "gentrap")
        def upload2 = UploadSet(UserExamples.avg, BiopetSummaryExamples.Gentrap.V04.MSampleMRG, "gentrap")
        def upload3 = UploadSet(UserExamples.avg, BiopetSummaryExamples.Gentrap.V04.MSampleSRG, "gentrap")
        ...
        "when using the default parameter should" >> inline {
          ...
          new Context.PriorRequests {
            ...
            "return a JSON object containing the expected attributes" in {
              ...
              priorResponse.body must /("read1") / "pctBasesA"  /("nDataPoints" -> 6)
              priorResponse.body must /("read1") / "pctBasesT"  /("nDataPoints" -> 6)
              priorResponse.body must /("read1") / "pctBasesG"  /("nDataPoints" -> 6)
              priorResponse.body must /("read1") / "pctBasesC"  /("nDataPoints" -> 6)
              priorResponse.body must /("read1") / "pctBasesN"  /("nDataPoints" -> 6)
              priorResponse.body must /("read1") / "pctBasesGC"  /("nDataPoints" -> 6)
              // read2
              ...
              priorResponse.body must /("read2") / "pctBasesA"  /("nDataPoints" -> 2)
              priorResponse.body must /("read2") / "pctBasesT"  /("nDataPoints" -> 2)
              priorResponse.body must /("read2") / "pctBasesG"  /("nDataPoints" -> 2)
        ...
        "when libType is set to 'paired' should" >> inline {
          ...
          new Context.PriorRequests {
            ...
            "return a JSON object containing the expected attributes" in {
              ...
              priorResponse.body must /("read1") / "pctBasesA"  /("nDataPoints" -> 2)
              priorResponse.body must /("read1") / "pctBasesT"  /("nDataPoints" -> 2)
              priorResponse.body must /("read1") / "pctBasesG"  /("nDataPoints" -> 2)
              priorResponse.body must /("read1") / "pctBasesC"  /("nDataPoints" -> 2)
              priorResponse.body must /("read1") / "pctBasesN"  /("nDataPoints" -> 2)
              priorResponse.body must /("read1") / "pctBasesGC"  /("nDataPoints" -> 2)
              // read2
              priorResponse.body must /("read2") / "nBases"  /("nDataPoints" -> 2)
              priorResponse.body must /("read2") / "nBasesA"  /("nDataPoints" -> 2)
              priorResponse.body must /("read2") / "nBasesT"  /("nDataPoints" -> 2)
        ...
        "when libType is set to 'single' should" >> inline {
          ...
          new Context.PriorRequests {
            ...
            "return a JSON object containing the expected attributes" in {
              ...
              priorResponse.body must /("read1") / "pctBasesA"  /("nDataPoints" -> 4)
              priorResponse.body must /("read1") / "pctBasesT"  /("nDataPoints" -> 4)
              priorResponse.body must /("read1") / "pctBasesG"  /("nDataPoints" -> 4)
              priorResponse.body must /("read1") / "pctBasesC"  /("nDataPoints" -> 4)
              priorResponse.body must /("read1") / "pctBasesN"  /("nDataPoints" -> 4)
