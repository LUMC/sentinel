...
class GentrapV04ValidationSpec extends Specification with SchemaValidationSpec with Mockito { def is = s2"""
...
"""
  ...
  val gentrapV04InputProcessor = new GentrapV04InputProcessor(mockDb)
