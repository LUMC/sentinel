...
import nl.lumc.sasc.sentinel.biopet.gentrap._
import nl.lumc.sasc.sentinel.models._
import nl.lumc.sasc.sentinel.utils._

/**
 * LUMC-specific controller for the `/stats` endpoint.
 *
 * @param swagger Container for main Swagger specification.
 * @param mongo Object for accessing the database.
 */
class StatsController(implicit val swagger: Swagger, val mongo: MongodbAccessObject) extends BaseStatsController { self =>
